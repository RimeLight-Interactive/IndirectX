use crate::fn_typedefs::context::ExecuteCommandList;
...
static ORIG_FUNC: OnceLock<ExecuteCommandList> = OnceLock::new();
...
pub fn hooked_func(
    this: *mut c_void,
    commandlist: *mut ID3D11CommandList,
    a: BOOL,
) {
    unsafe {
        let func = ORIG_FUNC.get().unwrap();
        func(this, commandlist, a)
    }
}
