use crate::fn_typedefs::context::IASetVertexBuffers;
...
static ORIG_FUNC: OnceLock<IASetVertexBuffers> = OnceLock::new();
...
pub fn hooked_func(
    ...
    a: u32,
    b: u32,
    buffer: *const *mut ID3D11Buffer,
    c: *const u32,
    d: *const u32,
) {
    unsafe {
        let func = ORIG_FUNC.get().unwrap();
        func(this, a, b, buffer, c, d)
    }
}
