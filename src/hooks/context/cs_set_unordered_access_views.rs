use crate::fn_typedefs::context::CSSetUnorderedAccessViews;
...
static ORIG_FUNC: OnceLock<CSSetUnorderedAccessViews> = OnceLock::new();
...
pub fn hooked_func(
    ...
    unsafe {
        ...
        func(this, a, b, unorderedaccessview, c)
    }
}
