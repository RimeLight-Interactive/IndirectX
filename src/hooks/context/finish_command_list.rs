use crate::fn_typedefs::context::FinishCommandList;
...
static ORIG_FUNC: OnceLock<FinishCommandList> = OnceLock::new();
...
pub fn hooked_func(
    this: *mut c_void,
    a: BOOL,
    commandlist: *mut *mut ID3D11CommandList,
) -> HRESULT {
    unsafe {
        let func = ORIG_FUNC.get().unwrap();
        func(this, a, commandlist)
    }
}
