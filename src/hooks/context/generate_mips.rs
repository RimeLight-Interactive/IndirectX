use crate::fn_typedefs::context::GenerateMips;
...
static ORIG_FUNC: OnceLock<GenerateMips> = OnceLock::new();
...
pub fn hooked_func(
    this: *mut c_void,
    shaderresourceview: *mut ID3D11ShaderResourceView,
) {
    unsafe {
        let func = ORIG_FUNC.get().unwrap();
        func(this, shaderresourceview)
    }
}
