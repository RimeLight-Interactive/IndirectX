use crate::fn_typedefs::context::VSSetShader;
...
static ORIG_FUNC: OnceLock<VSSetShader> = OnceLock::new();
...
pub fn hooked_func(
    this: *mut c_void,
    vertexshader: *mut ID3D11VertexShader,
    classinstance: *const *mut ID3D11ClassInstance,
    a: u32,
) {
    unsafe {
        let func = ORIG_FUNC.get().unwrap();
        func(this, vertexshader, classinstance, a)
    }
}
